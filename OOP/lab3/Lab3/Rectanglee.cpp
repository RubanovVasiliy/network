...
Rectanglee::Rectanglee() {
	float temp_x = rand() % 100 / 1000.f;
	float temp_y = rand() % 100 / 1000.f;

	this->point[0].x = temp_x;
	this->point[0].y = temp_y;

	this->point[1].x = -temp_x;
	this->point[1].y = temp_y;

	this->point[2].x = -temp_x;
	this->point[2].y = -temp_y;

	this->point[3].x = temp_x;
	this->point[3].y = -temp_y;

	printf("constructor Rectanglee\n");
}
